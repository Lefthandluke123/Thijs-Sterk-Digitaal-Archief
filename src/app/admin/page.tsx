  ...
  return (
    <SidebarProvider defaultOpen={true}>
      <div className="flex min-h-screen bg-background w-full">
        <Sidebar collapsible="icon" className="border-r border-border/20 w-16 group-data-[state=expanded]:w-56 transition-all duration-300">
              ...
              <SidebarMenu>
                <SidebarMenuItem>
                  ...
                  >
                    ...
                    <span className="group-data-[state=collapsed]:hidden ml-3 font-medium">Nieuwe Import</span>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>
                  <SidebarMenuButton 
                  ...
                  >
                    ...
                    <span className="group-data-[state=collapsed]:hidden ml-3 font-medium">Mijn Collectie</span>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>
                  <SidebarMenuButton 
                  ...
                  >
                    ...
                    <span className="group-data-[state=collapsed]:hidden ml-3 font-medium">Instellingen</span>
                  </SidebarMenuButton>
                </SidebarMenuItem>
              </SidebarMenu>
            </SidebarGroup>
              ...
              <SidebarMenu>
                <SidebarMenuItem>
                  ...
                  >
                    ...
                    <span className="group-data-[state=collapsed]:hidden ml-3 font-medium">Wissen</span>
                  </SidebarMenuButton>
                </SidebarMenuItem>
              </SidebarMenu>
            </SidebarGroup>
        ...
        <main className="flex-1 flex flex-col min-w-0 bg-background">
          <header className="h-16 border-b border-border/10 flex items-center justify-between px-6 bg-background/80 backdrop-blur-sm sticky top-0 z-20">
            <div className="flex items-center gap-4">
              <SidebarTrigger className="h-10 w-10 hover:bg-secondary">
