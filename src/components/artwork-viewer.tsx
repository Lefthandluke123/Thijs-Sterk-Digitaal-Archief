 ...
 * STABILIZED UI VERSION - Behoudt compacte knoppen en correcte lagen.
 */
export function ArtworkViewer({ artwork, onClose, onPrev, onNext }: ArtworkViewerProps) {
  ...
  return (
    ...
    >
      ...
      {/* 2. UI Nav Layer - Stabiele, compacte navigatie */}
        ...
        <div className="flex items-center gap-3 pointer-events-auto">
           ...
           {audio && (
             <button 
              onClick={toggleAudio} 
              className={cn(
                "p-4 rounded-full backdrop-blur-3xl border border-black/5 transition-all flex items-center gap-4 shadow-xl", 
           ...
           <button 
            ...
            className={cn(
              "p-4 rounded-full backdrop-blur-3xl border border-black/5 transition-all shadow-xl", 
           ...
           <button 
            onClick={onClose} 
            className="p-4 bg-white/90 backdrop-blur-3xl rounded-full text-foreground hover:bg-destructive hover:text-white transition-all border border-black/5 shadow-xl"
           >
             <X className="w-5 h-5" />
           </button>
        </div>
