...
const staticTranslations: Record<Language, Record<string, string>> = {
  nl: {
    ...
    curator_title: 'Maak uw eigen zaal! Word de conservator van uw eigen museum. Kies een van onze inspirerende thema’s en richt uw eigen virtuele tentoonstelling in. Combineer uw favoriete werken, experimenteer met opstellingen en geef uw creativiteit de vrije loop. Klaar? Open de deuren en deel uw unieke collectie met de wereld!',
    ...
    guide_curator_manual_title: 'Zelf Cureren',
    guide_curator_step1: 'Stap 1: Selecteer thema\'s of technieken die u aanspreken in de Curator-omgeving.',
  ...
  en: {
    ...
    guide_curator_manual_title: 'Self-Curating',
    guide_curator_step1: 'Step 1: Select themes or techniques that appeal to you in the Curator environment.',
  ...
  de: {
    ...
    guide_curator_manual_title: 'Selbst Kuratieren',
    ...
    guide_nav_tour_desc: 'Nutzen Sie die Pfeile oder den Fortschrittsbalken, um durch einen Raum zu gehen.',
    guide_nav_shop_desc: 'Zertifizierte Reproduktionen sind direkt bei jedem Werk erhältlich.',
    guide_viewer_title: 'Der Viewer',
    guide_viewer_zoom_label: 'Deep Zoom',
    guide_viewer_zoom_desc: 'Klicken oder scrollen Sie auf ein Werk, um bis zum Pinselstrich hineinzuzoomen.',
    guide_viewer_info_desc: 'Klicken Sie auf das Info-Icon für Jahreszahl, Technik und Geschichte.',
  ...
  fr: {
    ...
    guide_curator_manual_title: 'Auto-curation',
    guide_curator_step1: 'Étape 1 : Sélectionnez des thèmes ou des techniques dans l\'espace Conservateur.',
  ...
  es: {
    ...
    guide_curator_manual_title: 'Auto-comisariado',
    ...
    guide_nav_tour_desc: 'Utilice las flechas o la barra de progreso para caminar por una sala.',
