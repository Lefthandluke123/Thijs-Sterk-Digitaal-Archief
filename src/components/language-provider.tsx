...
const staticTranslations: Record<Language, Record<string, string>> = {
  nl: {
    ...
    homeRoomsBadge: 'De Rondleiding',
    homeRoomsTitle: 'Thematische Zalen',
    homeRoomsSubtitle: 'Wandel door de zorgvuldig samengestelde collecties.',
    ...
    curator_title: 'Word de inrichter van uw eigen museum.',
    curator_subtitle: 'Stel uw eigen expositie samen',
    curator_instruction: 'Maak 1, 2, 3 of 4 keuzes',
    curator_counter: '{count} van 4 gekozen',
    curator_limit_reached: 'Maximaal aantal keuzes bereikt',
    ...
    contact_label_message: 'Uw Bericht',
    contact_button_send: 'Verzenden',
  ...
  en: {
    ...
    homeRoomsBadge: 'The Tour',
    homeRoomsTitle: 'Thematic Rooms',
    homeRoomsSubtitle: 'Walk through carefully curated collections.',
    ...
    curator_title: 'Become the curator of your own museum.',
    curator_subtitle: 'Assemble your own exhibition',
    curator_instruction: 'Make 1, 2, 3 or 4 choices',
    curator_counter: '{count} of 4 selected',
    curator_limit_reached: 'Maximum number of choices reached',
  ...
  de: {
    ...
    curator_title: 'Werden Sie zum Kurator Ihres eigenen Museums.',
    curator_subtitle: 'Eigene Ausstellung zusammenstellen',
    curator_instruction: 'Wählen Sie 1, 2, 3 oder 4 Optionen',
    curator_counter: '{count} von 4 ausgewählt',
    curator_limit_reached: 'Maximale Auswahl erreicht',
  ...
  fr: {
    ...
    homeRoomsBadge: 'La Visite',
    homeRoomsTitle: 'Salles Thématiques',
    homeRoomsSubtitle: 'Promenez-vous dans des collections soigneusement sélectionnées.',
    ...
    curator_title: 'Devenez le commissaire de votre propre musée.',
    curator_subtitle: 'Composer votre propre exposition',
    curator_instruction: 'Faites 1, 2, 3 ou 4 choix',
    curator_counter: '{count} sur 4 sélectionnés',
    curator_limit_reached: 'Nombre maximum de choix atteint',
  ...
  es: {
    ...
    homeHeroTitle: 'Une vida dedicada a la luz, el espacio y el agua',
    ...
    homeRoomsBadge: 'El Recorrido',
    homeRoomsTitle: 'Salas Temáticas',
    homeRoomsSubtitle: 'Camina por colecciones cuidadosamente seleccionadas.',
    ...
    curator_title: 'Conviértase en el curador de su propio museo.',
    curator_subtitle: 'Componga su eigen exposición',
    curator_instruction: 'Haga 1, 2, 3 o 4 elecciones',
    curator_counter: '{count} de 4 seleccionados',
    curator_limit_reached: 'Límite máximo de elecciones alcanzado',
