...
import { Maximize2, ArrowRight, Palette } from 'lucide-react';
...
export function PortfolioGrid() {
  ...
  const portfolioTitle = (language !== 'nl' && siteSettings?.[`homePortfolioTitle_${language}`])
        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-8">
          <div className="max-w-2xl">
            <h2 id="portfolio-heading" className="font-headline text-[13px] md:text-[15px] font-light mb-2 tracking-tight uppercase">
              {portfolioTitle.split(' ').map((word: string, i: number, arr: string[]) => 
