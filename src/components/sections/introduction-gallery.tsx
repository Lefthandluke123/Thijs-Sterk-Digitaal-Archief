            ...
            {curatedArtworks?.map((item: any) => {
              ...
              return (
                <div key={item.id} className="group flex flex-col space-y-6 animate-subtle-fade">
                  <button 
                    className="relative aspect-[4/5] overflow-hidden rounded-[2rem] bg-black/[0.03] shadow-md transition-all duration-700 hover:shadow-2xl cursor-pointer flex items-center justify-center p-3 border border-black/5"
