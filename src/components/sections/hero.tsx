    ...
    <section className="relative min-h-[80vh] flex flex-col items-center justify-center pt-20 px-4 overflow-hidden">
      ...
      <div className="container mx-auto z-10 text-center">
        <div className="inline-block animate-fade-in-up">
          <span className="text-primary font-medium tracking-[0.2em] uppercase text-[10px] mb-4 block">
            Retrospectief &bull; Thijs Sterk (1913-1982)
          </span>
        </div>
        
        <h1 className="font-headline text-3xl md:text-4xl lg:text-5xl font-light tracking-tight text-foreground mb-8 max-w-4xl mx-auto leading-tight animate-fade-in-up delay-100">
          Thijs Sterk: Schilder van <span className="italic">Licht, Ruimte en Water</span>
        </h1>
        
        <p className="text-muted-foreground text-base md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed animate-fade-in-up delay-200 font-light opacity-80">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up delay-300">
          <Button size="lg" className="rounded-full px-10 bg-accent hover:bg-accent/90 text-accent-foreground font-bold uppercase tracking-widest text-[11px] h-12" asChild>
            <a href="/gallery">Bekijk de Zalen</a>
          </Button>
          <Button variant="outline" size="lg" className="rounded-full px-10 border-primary text-primary hover:bg-primary/5 font-bold uppercase tracking-widest text-[11px] h-12 group" asChild>
            <a href="#about">
              De Kunstenaar
      ...
      <div className="container mx-auto mt-16 z-10 px-4 animate-fade-in-up delay-500">
