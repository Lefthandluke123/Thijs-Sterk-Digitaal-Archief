      ...
      <div className="container mx-auto z-10 text-center">
        ...
        <div className="max-w-2xl mx-auto mb-12 space-y-6 animate-fade-in-up delay-200">
          <p className="text-muted-foreground text-lg md:text-xl leading-relaxed font-light">
            Wat goed dat u de weg naar dit digitale retrospectief heeft gevonden. We nodigen u uit om u te laten meevoeren door de atmosfeer van de polders, de kust en de verstilde dorpsgezichten die mijn vader zo meesterlijk wist te vangen.
          </p>
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed font-light">
            Dwaal op uw eigen tempo door de verschillende <span className="text-accent font-medium">thematische zalen</span> of gebruik de mogelijkheid om bij <span className="text-accent font-medium">"Uw Zaal"</span> een geheel eigen inkijk te creëren uit zijn omvangrijke oeuvre.
          </p>
        </div>
